...
RUN echo "Installing packages..." \
  ...
  && cmake --build . \
  && echo "export LIBRARY_PATH=/tutorial/cheetah/build/lib/x86_64-unknown-linux-gnu:/usr/local/lib/clang/12.0.0/lib/x86_64-unknown-linux-gnu" >> /etc/bash.bashrc \
  && echo "export LD_LIBRARY_PATH=/tutorial/cheetah/build/lib/x86_64-unknown-linux-gnu:/usr/local/lib/clang/12.0.0/lib/x86_64-unknown-linux-gnu" >> /etc/bash.bashrc \
